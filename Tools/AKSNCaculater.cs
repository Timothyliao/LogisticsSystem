...
namespace LogisticsSystem.Tools
{
    public class AKSNCaculater
    {
        ...
        /// <param name="querystring_arrays">升序排列</param>
        /// <returns></returns>
        ...
        public static string GDCaculateSN(string sk, IDictionary<string, string> querystring_arrays)
        {
            var queryString = HttpBuildQuery(querystring_arrays);

            var str = UrlEncode(queryString + sk);
